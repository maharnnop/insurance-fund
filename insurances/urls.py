...
urlpatterns = [
    ...
    path('insure/admin/create', views.InsuranceCreate.as_view(), name = 'insure_create'),
    path('insure/admin/<int:pk>',views.InsuranceUpdate_Del.as_view(), name='insure_edit_del'),
